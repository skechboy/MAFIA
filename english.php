...
DEFINE("_GG_DOUBLE",			        "Двапати го промаши златниот пиштол, доколку го промашиш уште еднаш одиш во 24 часовен притвор!");
...
DEFINE("_CLICK_ERROR2",					"Неможеш сам да си бидеш платен убиец!");
DEFINE("_CLICK_ERROR3",					"Упсс настана некоја грешка! <br> Ве молиме обидете се повторно.");
...
DEFINE("_FC_ERROR3",					"За основање на фамилија ти се потребни милион евра."); // NO MONEY
...
DEFINE("_FC_INFO1",					    "За да создадеш нова фамилија треба да го имаш рангот \"МАКРО\".<br><br>Внесете го саканото име:");
...
DEFINE("_FJ_INFO2",						"! Изборот е Ваш!");
...
DEFINE("_TOP_INFO1",					    "Листа на 100-те најуспешни мафијаши. ");
/*================================= STATS ==========================================*/
/*=== BANDITS ===*/
/*===*/
...
DEFINE("_AWARDS_INFO",						"На крајот од секоја сезона на играта ќе се врши доделување на медали. Редоследот на медалите е прикажан подолу, а рангирањето ќе се врши според критериумот Топ 100 играчи на MAFIAMK.");
/*=== ONLINE ===*/
...
DEFINE("_DEAD_MSG5",            		    "<br> Доколку си сопственик на железничка станица или аеродром, државата ќе ти ги одземи и ќе ги даде под јавна лицитација.<br><br> Твојот профил ќе биде реактивиран во рок од 24 часа");
?>
